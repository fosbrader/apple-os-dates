...
export const FORECAST_SHADOW_MAX_SOURCE_EVENTS = 2_304;
export const FORECAST_SHADOW_MAX_SOURCE_COMPATIBILITY_MILESTONES = 2_304;
export const FORECAST_SHADOW_MAX_SOURCE_OBSERVATIONS = 4_608;
export const FORECAST_SHADOW_MAX_SOURCE_METADATA = 512;
export const FORECAST_SHADOW_MAX_SOURCE_LEGACY_RELEASES = 512;
export const FORECAST_SHADOW_MAX_SOURCE_LEGACY_MILESTONES = 2_304;

...
async function run(): Promise<void> {
  ...
  const snapshot = {
    ...
    queryScript:
      "research-handoffs/beta-chronology-gap/ios-ipados-point-15-18/query-production.ts",
    ...
    productionCounts: {
      ...
      scopedPublicBetaEvents: events.filter((event) => event.channel === "publicBeta").length,

...
async function run(): Promise<void> {
  ...
  const outputPath =
    "tmp/research-evidence/beta-chronology-gap/macos-major-11-26/production-snapshot.json";
  await mkdir(
    ...
    JSON.stringify(
      {
        ...
        scopedPublicBetaEvents: snapshot.scopedPublicBetaEvents,

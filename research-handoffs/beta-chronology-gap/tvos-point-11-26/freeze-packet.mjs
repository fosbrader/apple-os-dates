...
if (
  ...
  throw new Error("A complete source fetch log is required before freeze.");
}
  ...
  const document = {
    ...
    exclusions: {
      ...
      sharedMutableAggregates:
        "Shared coverage/register/aggregate files are intentionally excluded. The exact 32 assignment rows are frozen in scoped-coverage-snapshot.json.",
      reason:

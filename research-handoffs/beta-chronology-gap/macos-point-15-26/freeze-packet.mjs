...
if (await exists(lockPath)) {
  ...
  const document = {
    ...
    exclusions: {
      ...
      reason:
        "The lock manifest cannot hash itself. The independent-review file remains writable only for a different reviewer and is intentionally excluded; all research inputs, outputs, and evidence are frozen.",
    },
    safety: {
